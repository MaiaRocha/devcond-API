...
class ReservationController extends Controller
{
    ...
    public function getDisabledDates($id) {
        ...
        //Listar os dias proibidos +3 meses p/ frente
    ...
    public function setReservation($id, Request $request) {
        ...
        if(!$validator->fails()) {
            ...
            if($unit && $area) {
                ...
                //verificar se está dentro da disponiblidade padrão
                $allowedDays = explode(',', $area['days']);
                if(!in_array($weekday, $allowedDays)) {
                    $can = false;
                } else {
                ...
                //Verificar se não existe reserva no mesmo dia/hora
